...
# -*- coding: utf-8 -*-
"""
UYAP DOSYA ANALYZER v5.0 (Oracle Enhanced)
========================================
Compatible with app.py v5.0 Ultimate UI.
Full legal intelligence restored from IcraUtils.
"""
        ...
        try:
            ...
            for root, _, files in os.walk(tmp_dir):
                for file in files:
                    ...
                    # Oracle Logic Restoration
                    if turu == EvrakTuru.HACIZ:
            ...
            if not sonuc.aksiyonlar:
                sonuc.ozet_rapor = "Kritik bir risk tespit edilmedi."
            else:
                sonuc.ozet_rapor = f"{len(sonuc.aksiyonlar)} adet aksiyon önerisi bulundu."
