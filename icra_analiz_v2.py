...
BANKA_LISTESI = [
    'Ziraat Bankası', 'Halkbank', 'Vakıfbank', 'Akbank', 'Garanti BBVA', 
    'Türkiye İş Bankası', 'Yapı Kredi', 'QNB Finansbank', 'Denizbank', 
    'TEB', 'ING', 'HSBC', 'Şekerbank', 'Kuveyt Türk', 'Türkiye Finans', 
    'Albaraka', 'Ziraat Katılım', 'Vakıf Katılım', 'Emlak Katılım', 
    'Odeabank', 'Fibabanka', 'Anadolubank', 'Burgan Bank'
]
